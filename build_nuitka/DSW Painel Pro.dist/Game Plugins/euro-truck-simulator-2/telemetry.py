...
def _runtime():
    ...
    if _runtime_module is None:
        runtime_path = Path(__file__).resolve().parent / "runtime" / "ets2sdkclient.py"
        spec = importlib.util.spec_from_file_location("ets2_runtime", runtime_path)
