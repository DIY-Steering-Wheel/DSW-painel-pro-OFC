...
GAME_DIR_NAME = "FarmingSimulator2025"
MOD_FOLDER_NAME = "TelemetriaFarmingSimulator25"
...
def install(folder, plugin_dir: Path):
    ...
    return "Mod Farming Simulator 25 instalado com sucesso."
...
def uninstall(folder, plugin_dir: Path):
    ...
    if target.exists():
        shutil.rmtree(target)
    return "Mod Farming Simulator 25 removido com sucesso."
